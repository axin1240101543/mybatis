...
public class MyClassPathMapperScanner extends ClassPathBeanDefinitionScanner {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MyClassPathMapperScanner.class);
    ...
    private Class<? extends MyMapperFactoryBean> mapperFactoryBeanClass = MyMapperFactoryBean.class;
     ...
     */
    @Deprecated
    public void setMapperFactoryBean(MyMapperFactoryBean<?> mapperFactoryBean) {
        this.mapperFactoryBeanClass = mapperFactoryBean == null ? MyMapperFactoryBean.class : mapperFactoryBean.getClass();
    }
    ...
    public void setMapperFactoryBeanClass(Class<? extends MyMapperFactoryBean> mapperFactoryBeanClass) {
        this.mapperFactoryBeanClass = mapperFactoryBeanClass == null ? MyMapperFactoryBean.class : mapperFactoryBeanClass;
    }
